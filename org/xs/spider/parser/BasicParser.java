...
public class BasicParser implements Parser {
    ...
    public String removeTails(String contentStr) {
        String[] tails = new String[]{"【免责声明", "【版权声明", "【重点推荐", "【延伸阅读",
                "【推荐阅读", "【相关阅读", "免责声明", "版权声明", "【更多详情", "【相关专题","上一篇：","下一篇：","作品版权归作者","Copyright"
                ,"商务洽谈","广告合作","友情连接","侵权举报","请联系客服","与本站立场无关","可发送邮件至","All Rights Reserved","版权所有","提问和意见反馈",
                "返回书目","返回上一章","进入下一章","微信扫一扫","提问和意见反馈","提示：","来自助手版贴吧客户端","刷新页面就可以看啦","扫码用手机继续",
                "扫码后可分享给好友","更多精彩活动敬请关注","关注微信公众号","用或微信扫码在手机上继续观看","二维码2小时内有效","作品连载中","作品已完成","VIP充值"
        ,"条记录","作者有话要说","添加评论","小提示："
        };
    ...
    public Element getContentEle(Document document) {
        denoiseForDoc(document);//过滤1
        Element element = excavateContent(document);//过滤2
        if (element == null) {
            return null;
        }
        denioseForContentElement(element);//过滤三
        downloadImg(element);
